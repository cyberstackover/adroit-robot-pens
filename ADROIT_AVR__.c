...
{   return ((sudut*200)/18 + 2000);}
#pragma used-

#pragma used+
SudutServo1(unsigned char posisi)
{   dServo1 = SetSudut(posisi);}
#pragma used-
#pragma used+
SudutServo2(unsigned char posisi)
{   dServo2 = SetSudut(posisi);}
#pragma used-
#pragma used+
SudutServo3(unsigned char posisi)
{   dServo3 = SetSudut(posisi);}
#pragma used-
#pragma used+
SudutServo4(unsigned char posisi)
{   dServo4 = SetSudut(posisi);}
#pragma used-
#pragma used+
SudutServo5(unsigned char posisi)
{   dServo5 = SetSudut(posisi);}
#pragma used-
#pragma used+
SudutServo6(unsigned char posisi)
{   dServo6 = SetSudut2(posisi);}
#pragma used-
#pragma used+
SudutServo7(unsigned char posisi)
{   dServo7 = SetSudut2(posisi);}
#pragma used-
#pragma used+
SudutServo8(unsigned char posisi)
{   //unsigned int x;
    //x = SetSudut2(posisi);
    #asm ("	RCALL SUBOPT_0x9")
    #asm ("STS 0x0079,R31")
	#asm ("STS 0x0079,R30")
}    
#pragma used-
